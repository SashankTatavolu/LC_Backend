...
#     english_text = Column(Text)  # Added column for English translation
#     wx_text = Column(Text)
...
# def main():
#     file_path = "/home/sashank/Downloads/Language_Communicator_Backend/application/data_insertions/7sentences/segments.txt"  

#     chapter_id = 1  # Example: Use the specific chapter_id for the sentences being processed
