...
#     hindi_label = Column(String(255), nullable=False)
#     english_label = Column(String(255), nullable=False)
...
#             if len(parts) >= 3:
#                 hindi_label = parts[1]
#                 english_label = parts[2]
#                 concepts.append({'hindi_label': hindi_label, 'english_label': english_label})
#     return concepts
...
# concept_file_path = '/home/sashank/Downloads/concept-to-mrs-rels.dat'
