...
#     # @staticmethod
#     # def update_construction_by_segment(segment_id, construction_data):
#     #     existing_construction = Construction.query.filter_by(segment_id=segment_id).all()
...
#     #         construction_text = data['construction']
...
#     #         else:
#     #             # If no construction_id or not found, create a new entry
#     #             construction = Construction(
#     #                 segment_id=segment_id,
...
#     #         # Update the construction attributes
...
#     #         updated_construction.append(construction)
